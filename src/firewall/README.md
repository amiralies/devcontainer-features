...
```json
"features": {
    "ghcr.io/amiralies/devcontainer-features/firewall:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/amiralies/devcontainer-features/blob/main/src/firewall/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
